...
\item Its the backbone of the project and will be the main dependency of \mbox{\hyperlink{namespace_markov_passwords}{Markov\+Passwords}} to work.
\end{DoxyItemize}
\item \mbox{\hyperlink{namespace_markov_passwords}{Markov\+Passwords}}
\begin{DoxyItemize}
...
\item As an example, this will read the dataset file, and pass each line to \mbox{\hyperlink{class_markov_1_1_model_a7c334d47dfa1920e643b02f57ecbec9e}{Markov\+::\+Model\+::adjust}} when training.
...
\mbox{\hyperlink{namespace_markov_passwords}{Markov\+Passwords}} should read input from our dataset file, parse it line by line, and feed it to \mbox{\hyperlink{class_markov_1_1_model_a7c334d47dfa1920e643b02f57ecbec9e}{Markov\+::\+Model\+::adjust}}

Once a training is complete, \mbox{\hyperlink{namespace_markov_passwords}{Markov\+Passwords}} is supposed to export the model to a savefile so that model is not required to train for each run.\hypertarget{index_autotoc_md8}{}\doxysubsection{Generation}\label{index_autotoc_md8}
Generation is done by invoking \mbox{\hyperlink{class_markov_1_1_model_a01d659097ae6f9113ddc5946f7ce571a}{Markov\+::\+Model\+::\+Random\+Walk}} as many times as neccessary, and writing the result to a file line by line.\hypertarget{index_autotoc_md9}{}\doxysubsection{Testing/\+Cracking}\label{index_autotoc_md9}

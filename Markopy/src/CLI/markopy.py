...
def cli_train(model : markopy.ModelMatrix, dataset : str, seperator : str, output : str, output_forced : bool=False, bulk : bool=False):
...
def cli_generate(model : markopy.ModelMatrix, wordlist : str, bulk : bool=False):

...
\end{DoxyItemize}
\item \mbox{\hyperlink{class_markov_passwords_g_u_i}{Markov\+Passwords\+G\+UI}}
\begin{DoxyItemize}
...
\item Comparison graphs of number of cracked passwords using traditional wordlists, our generated wordlist, and complete incremental approach (where each password is checked one by one like A\+A\+AA, A\+A\+AB, A\+A\+AC, A\+A\+AD...) 
\end{DoxyItemize}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{class_markov_1_1_a_p_i_1_1_markov_passwords__coll__graph}
\end{center}
\end{figure}
...
\mbox{\hyperlink{class_markov_1_1_a_p_i_1_1_markov_passwords_ab7f0caaea1f96d4fdeea126f78d7081f}{Markov\+Passwords}} (const \mbox{\hyperlink{classchar}{char}} $\ast$filename)
...
void \mbox{\hyperlink{class_markov_1_1_a_p_i_1_1_markov_passwords_a2fd4423ae3850e258dcb6b11a7feb9b2}{Train}} (const \mbox{\hyperlink{classchar}{char}} $\ast$dataset\+File\+Name, \mbox{\hyperlink{classchar}{char}} delimiter, int threads)
...
{\footnotesize\ttfamily Markov\+::\+A\+P\+I\+::\+Markov\+Passwords\+::\+Markov\+Passwords (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classchar}{char}} $\ast$}]{filename }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily void \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{classchar}{char}}  $>$\+::Adjust\+Edge (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classchar}{char}}  $\ast$}]{payload,  }\item[{long int}]{occurrence }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inherited]}}
...
{\footnotesize\ttfamily void Markov\+::\+A\+P\+I\+::\+Markov\+Passwords\+::\+Buff (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classchar}{char}} $\ast$}]{str,  }\item[{double}]{multiplier,  }\item[{bool}]{b\+Dont\+Adjust\+Self\+Loops = {\ttfamily true},  }\item[{bool}]{b\+Dont\+Adjust\+Extended\+Loops = {\ttfamily false} }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily std\+::vector$<$\mbox{\hyperlink{class_markov_1_1_edge}{Edge}}$<$\mbox{\hyperlink{classchar}{char}} $>$$\ast$$>$$\ast$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{classchar}{char}}  $>$\+::Edges\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [inherited]}}
...
{\footnotesize\ttfamily void Markov\+::\+A\+P\+I\+::\+Markov\+Passwords\+::\+Generate (\begin{DoxyParamCaption}\item[{unsigned long int}]{n,  }\item[{const \mbox{\hyperlink{classchar}{char}} $\ast$}]{wordlist\+File\+Name,  }\item[{int}]{min\+Len = {\ttfamily 6},  }\item[{int}]{max\+Len = {\ttfamily 12},  }\item[{int}]{threads = {\ttfamily 20} }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily bool \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{classchar}{char}}  $>$\+::Import (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classchar}{char}} $\ast$}]{filename }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inherited]}}
...
{\footnotesize\ttfamily std\+::map$<$\mbox{\hyperlink{classchar}{char}} , \mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$\mbox{\hyperlink{classchar}{char}} $>$$\ast$$>$$\ast$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{classchar}{char}}  $>$\+::Nodes\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [inherited]}}
...
{\footnotesize\ttfamily std\+::ifstream $\ast$ Markov\+::\+A\+P\+I\+::\+Markov\+Passwords\+::\+Open\+Dataset\+File (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classchar}{char}} $\ast$}]{filename }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \mbox{\hyperlink{classchar}{char}}  $\ast$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{classchar}{char}}  $>$\+::Random\+Walk (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{class_markov_1_1_random_1_1_random_engine}{Markov\+::\+Random\+::\+Random\+Engine}} $\ast$}]{random\+Engine,  }\item[{int}]{min\+Setting,  }\item[{int}]{max\+Setting,  }\item[{\mbox{\hyperlink{classchar}{char}}  $\ast$}]{buffer }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inherited]}}
...
{\footnotesize\ttfamily std\+::ofstream $\ast$ Markov\+::\+A\+P\+I\+::\+Markov\+Passwords\+::\+Save (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classchar}{char}} $\ast$}]{filename }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily \mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$\mbox{\hyperlink{classchar}{char}} $>$$\ast$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{classchar}{char}}  $>$\+::Starter\+Node\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [inherited]}}
...
{\footnotesize\ttfamily void Markov\+::\+A\+P\+I\+::\+Markov\+Passwords\+::\+Train (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{classchar}{char}} $\ast$}]{dataset\+File\+Name,  }\item[{\mbox{\hyperlink{classchar}{char}}}]{delimiter,  }\item[{int}]{threads }\end{DoxyParamCaption})}
...
References \mbox{\hyperlink{markov_passwords_8cpp_source_l00026}{int\+Handler()}}, \mbox{\hyperlink{thread_shared_list_handler_8cpp_source_l00012}{Markov\+::\+A\+P\+I\+::\+Concurrency\+::\+Thread\+Shared\+List\+Handler\+::\+Thread\+Shared\+List\+Handler()}}, and \mbox{\hyperlink{markov_passwords_8cpp_source_l00085}{Train\+Thread()}}.



Referenced by \mbox{\hyperlink{markopy_8cpp_source_l00034}{Markov\+::\+Markopy\+::\+B\+O\+O\+S\+T\+\_\+\+P\+Y\+T\+H\+O\+N\+\_\+\+M\+O\+D\+U\+L\+E()}}, \mbox{\hyperlink{_train_8cpp_source_l00038}{Markov\+::\+G\+U\+I\+::\+Train\+::train()}}, \mbox{\hyperlink{_generate_8cpp_source_l00082}{Markov\+::\+G\+U\+I\+::\+Generate\+::train()}}, and \mbox{\hyperlink{model_matrix_8cpp_source_l00025}{Markov\+::\+A\+P\+I\+::\+Model\+Matrix\+::\+Train()}}.

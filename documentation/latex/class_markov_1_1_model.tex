...
\begin{center}
\leavevmode
\includegraphics[height=550pt]{class_markov_1_1_model__coll__graph}
\end{center}
\end{figure}
...
\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $\ast$ \mbox{\hyperlink{class_markov_1_1_model_aa4a11c6679c998936332f8409ae95375}{Random\+Walk}} (\mbox{\hyperlink{class_markov_1_1_random_1_1_random_engine}{Markov\+::\+Random\+::\+Random\+Engine}} $\ast$random\+Engine, int min\+Setting, int max\+Setting, \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $\ast$buffer)
\begin{DoxyCompactList}\small\item\em Do a random walk on this model. \end{DoxyCompactList}\item 
void \mbox{\hyperlink{class_markov_1_1_model_ad252913f83fa3eb14cc3f9f92c5ee37a}{Adjust\+Edge}} (const \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $\ast$payload, long int occurrence)
...
\mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$ $\ast$ \mbox{\hyperlink{class_markov_1_1_model_a0e53104e4ec665f005529f51a80c857d}{Starter\+Node}} ()
\begin{DoxyCompactList}\small\item\em Return starter \mbox{\hyperlink{class_markov_1_1_node}{Node}}. \end{DoxyCompactList}\item 
std\+::vector$<$ \mbox{\hyperlink{class_markov_1_1_edge}{Edge}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$ $\ast$ $>$ $\ast$ \mbox{\hyperlink{class_markov_1_1_model_a2e08608905d7b042627ea844b08045fe}{Edges}} ()
\begin{DoxyCompactList}\small\item\em Return a vector of all the edges in the model. \end{DoxyCompactList}\item 
std\+::map$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}}, \mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$ $\ast$ $>$ $\ast$ \mbox{\hyperlink{class_markov_1_1_model_a71f6df805e340ce96e9dc4ee4ebc6537}{Nodes}} ()
\begin{DoxyCompactList}\small\item\em Return starter \mbox{\hyperlink{class_markov_1_1_node}{Node}}. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactItemize}
\item 
std\+::map$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}}, \mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$ $\ast$ $>$ \mbox{\hyperlink{class_markov_1_1_model_aa772f79f444c2971f615df7be5e28bca}{nodes}}
...
\mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$ $\ast$ \mbox{\hyperlink{class_markov_1_1_model_ad2d9bf601df78f80076f5d3fbb65fe28}{starter\+Node}}
...
std\+::vector$<$ \mbox{\hyperlink{class_markov_1_1_edge}{Edge}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$ $\ast$ $>$ \mbox{\hyperlink{class_markov_1_1_model_a06d54b6e00a7e92b2c3bf72e1bfa560a}{edges}}
...
\mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::\mbox{\hyperlink{class_markov_1_1_model}{Model}}}
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
void \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Adjust\+Edge (\begin{DoxyParamCaption}\item[{const \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $\ast$}]{payload,  }\item[{long int}]{occurrence }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
std\+::vector$<$\mbox{\hyperlink{class_markov_1_1_edge}{Edge}}$<$\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}}$>$$\ast$$>$$\ast$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Edges (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
bool \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Export (\begin{DoxyParamCaption}\item[{const char $\ast$}]{filename }\end{DoxyParamCaption})}
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
bool \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Export (\begin{DoxyParamCaption}\item[{std\+::ofstream $\ast$}]{f }\end{DoxyParamCaption})}
...
Referenced by \mbox{\hyperlink{markov_passwords_8cpp_source_l00106}{Markov\+::\+API\+::\+Markov\+Passwords\+::\+Save()}}.
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
bool \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Import (\begin{DoxyParamCaption}\item[{const char $\ast$}]{filename }\end{DoxyParamCaption})}
...
Referenced by \mbox{\hyperlink{markopy_8cpp_source_l00037}{Markov\+::\+Markopy\+::\+BOOST\+\_\+\+PYTHON\+\_\+\+MODULE()}}, \mbox{\hyperlink{model_matrix_8cpp_source_l00019}{Markov\+::\+API\+::\+Model\+Matrix\+::\+Import()}}, and \mbox{\hyperlink{markov_passwords_8cpp_source_l00039}{Markov\+::\+API\+::\+Markov\+Passwords\+::\+Markov\+Passwords()}}.
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
bool \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Import (\begin{DoxyParamCaption}\item[{std\+::ifstream $\ast$}]{f }\end{DoxyParamCaption})}
...
Referenced by \mbox{\hyperlink{markov_passwords_8cpp_source_l00051}{Markov\+::\+API\+::\+Markov\+Passwords\+::\+Open\+Dataset\+File()}}.
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
std\+::map$<$\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}}, \mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}}$>$$\ast$$>$$\ast$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Nodes (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
void \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Optimize\+Edge\+Order}
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $\ast$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Random\+Walk (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{class_markov_1_1_random_1_1_random_engine}{Markov\+::\+Random\+::\+Random\+Engine}} $\ast$}]{random\+Engine,  }\item[{int}]{min\+Setting,  }\item[{int}]{max\+Setting,  }\item[{\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $\ast$}]{buffer }\end{DoxyParamCaption})}
...
Referenced by \mbox{\hyperlink{markov_passwords_8cpp_source_l00140}{Markov\+::\+API\+::\+Markov\+Passwords\+::\+Generate\+Thread()}}.
...
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
\mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$$\ast$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::Starter\+Node (\begin{DoxyParamCaption}{ }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
\begin{center}
\leavevmode
\includegraphics[width=350pt]{class_markov_1_1_model_a0e53104e4ec665f005529f51a80c857d_icgraph}
\end{center}
\end{figure}
...
\doxysubsubsection{\texorpdfstring{edges}{edges}}
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
std\+::vector$<$\mbox{\hyperlink{class_markov_1_1_edge}{Edge}}$<$\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}}$>$$\ast$$>$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::edges\hspace{0.3cm}{\ttfamily [private]}}
...
\doxysubsubsection{\texorpdfstring{nodes}{nodes}}
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
std\+::map$<$\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}}, \mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}}$>$$\ast$$>$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::nodes\hspace{0.3cm}{\ttfamily [private]}}
...
\doxysubsubsection{\texorpdfstring{starterNode}{starterNode}}
{\footnotesize\ttfamily template$<$typename Node\+Storage\+Type $>$ \\
\mbox{\hyperlink{class_markov_1_1_node}{Node}}$<$\mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}}$>$$\ast$ \mbox{\hyperlink{class_markov_1_1_model}{Markov\+::\+Model}}$<$ \mbox{\hyperlink{class_node_storage_type}{Node\+Storage\+Type}} $>$\+::starter\+Node\hspace{0.3cm}{\ttfamily [private]}}
...
\item 
Markopy/\+Markov\+Model/src/\mbox{\hyperlink{model_8h}{model.\+h}}\end{DoxyCompactItemize}
